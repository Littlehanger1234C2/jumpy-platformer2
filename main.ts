...
function animateIdle () {
    ...
    mainIdleLeft.addAnimationFrame(img`
        ...
        . f d 1 1 1 d d 1 1 1 d e d f . 
        . f d f 1 1 d d f 1 1 d d e f . 
        . f d 1 1 1 d d 1 1 1 d d f . . 
    ...
    mainIdleRight.addAnimationFrame(img`
        ...
        . f d e d 1 1 1 d d 1 1 1 d f . 
        . f e d d 1 1 f d d 1 1 f d f . 
        . . f d d 1 1 1 d d 1 1 1 d f . 
        . . f d d d d d d d d d d d f . 
...
function animateRun () {
    ...
    mainRunLeft.addAnimationFrame(img`
        ...
        . f d 1 1 1 d e d e e f . . . . 
        . f d f 1 1 d d e e e f . . . . 
        . f d 1 1 1 d d d d d f . . . . 
...
function createEnemies () {
    ...
    for (let value5 of tiles.getTilesByType(assets.tile`tile4`)) {
        bumper = sprites.create(img`
            ...
            . . e e e e e e e e e e e e . . 
            . . e e e e e e e e e e e e . . 
            . . e e 1 1 1 e e 1 1 1 e e . . 
            . . e e 1 f 1 e e 1 f 1 e e . . 
            . . e e 1 f 1 e e 1 f 1 e e . . 
            . . e e 1 f 1 e e 1 f 1 e e . . 
            . . e e 1 1 1 e e 1 1 1 e e . . 
            . . e e e e e e e e e e e e . . 
